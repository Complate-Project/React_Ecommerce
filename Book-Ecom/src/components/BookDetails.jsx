      ...
      <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-8">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="text-xl text-gray-600 mb-6">লেখক: {book.author}</p>
            ...
            <div className="flex items-center space-x-4 mb-6">
              ...
              <span className="text-gray-600">({book.reviews} রিভিউ)</span>
            </div>
            ...
            <div className="flex items-center space-x-4 mb-6">
              ...
              <span className="bg-green-100 text-green-800 px-3 py-1 rounded-full font-semibold">
                সাশ্রয় {(book.originalPrice - book.price).toFixed(2)} Tk
              </span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
              ...
              >
                <FaShoppingCart />
                <span>এখনই কিনুন - {totalPrice} Tk</span>
              </button>
            </div>
            ...
            <div className="mt-8 grid grid-cols-2 gap-4 text-sm text-gray-600">
              <div className="flex items-center space-x-2">
                <FaShippingFast />
                <span>বিশ্বব্যাপী ফ্রি শিপিং</span>
              </div>
              <div className="flex items-center space-x-2">
                <FaLock />
        ...
        <div className="bg-gray-50 p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div>
              <h4 className="font-semibold text-gray-700">পৃষ্ঠা সংখ্যা</h4>
              <p className="text-gray-600">{book.details.pages}</p>
            </div>
            <div>
              <h4 className="font-semibold text-gray-700">ভাষা</h4>
              <p className="text-gray-600">{book.details.language}</p>
            </div>
            <div>
              <h4 className="font-semibold text-gray-700">প্রকাশক</h4>
              <p className="text-gray-600">{book.details.publisher}</p>
            </div>
            <div>
              <h4 className="font-semibold text-gray-700">প্রকাশের তারিখ</h4>
